  ...
  return (
    ...
    >
      ...
      <ResponsiveDialog
        ...
        description="This action cannot be undone. If you paid online, a refund will be initiated automatically."
        size="md"
        isDirty={!!actions.cancelReason.trim()}
        footer={
          <>
            <Button
              variant="outline"
        ...
        <div className="space-y-3.5">
          {cancelApt && (
            <div className="rounded-2xl border border-white/50 bg-gray-50/50 p-4 text-sm text-gray-950">
              <p className="font-bold text-gray-900">{cancelApt.doctor_name}</p>
      ...
      <ResponsiveDialog
        ...
        description={`Pick a new date and time slot. Your current slot will be released.${rescheduleApt?.payment_status === "paid" ? " Payment will transfer to the new appointment automatically." : ""}`}
        size="xl"
        isDirty={!!actions.rescheduleSlot || !!actions.rescheduleNote.trim()}
        footer={
          <>
            <Button
              variant="outline"
