...
export const DoctorConsultationWorkspace = React.memo(
      ...
      <div className="space-y-4">
        <div>
          ...
          <textarea
            ...
            onChange={(e) =>
              handleFieldChange("chief_complaints", e.target.value)
            }
              ...
              >
                ...
                <div className="flex flex-col items-end gap-1">
                  ...
                  {h.prescription_status === "final" && (
                    <span className="text-[9px] text-emerald-500 font-bold tracking-tight">
                      Rx Saved
                    </span>
                  )}
                </div>
...
const MedicineWorkspaceCard = React.memo(
  function MedicineWorkspaceCard({
    item,
    index,
    disabled,
    onUpdate,
